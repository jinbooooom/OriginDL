...
TEST_F(CudaDivTest, ThreeDimensionalDivision) {
    // 测试三维张量除法
    auto a = Tensor(std::vector<float>{8.0f, 16.0f, 24.0f, 32.0f, 40.0f, 48.0f, 56.0f, 64.0f}, Shape{2, 2, 2}, dtype(Float32).device(kCUDA));
    auto b = Tensor(std::vector<float>{2.0f, 4.0f, 6.0f, 8.0f, 10.0f, 12.0f, 14.0f, 16.0f}, Shape{2, 2, 2}, dtype(Float32).device(kCUDA));
...
TEST_F(CudaDivTest, LargeNumbersDivision) {
    // 测试大数值除法
    auto a = Tensor(std::vector<float>{1000000.0f, 2000000.0f, 3000000.0f, 4000000.0f}, Shape{2, 2}, dtype(Float32).device(kCUDA));
