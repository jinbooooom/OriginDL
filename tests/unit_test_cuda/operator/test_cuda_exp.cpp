...
{
    // 测试三维张量指数
    auto a = Tensor(std::vector<float>{0.0f, 1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f}, Shape{2, 2, 2},
    ...
    auto result_data            = result.to_vector<float>();
    std::vector<float> expected = {std::exp(0.0f), std::exp(1.0f), std::exp(2.0f), std::exp(3.0f),
