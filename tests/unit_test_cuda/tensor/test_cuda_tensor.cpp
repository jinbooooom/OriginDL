...
TEST_F(CudaTensorTest, DifferentShapes) {
    ...
    auto tensor_3d = Tensor(std::vector<float>{1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f, 8.0f}, Shape{2, 2, 2}, dtype(Float32).device(kCUDA));
...
TEST_F(CudaTensorTest, ShapeValidation) {
    // 测试形状验证
    auto tensor = Tensor(std::vector<float>{1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f}, Shape{2, 3}, dtype(Float32).device(kCUDA));
