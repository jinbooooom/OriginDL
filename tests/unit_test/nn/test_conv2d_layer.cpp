...
{
    // 测试无效的构造函数参数
    EXPECT_THROW({ nn::Conv2d conv(0, 64, {3, 3}, {1, 1}, {1, 1}, true); }, std::invalid_argument);

    EXPECT_THROW({ nn::Conv2d conv(1, 0, {3, 3}, {1, 1}, {1, 1}, true); }, std::invalid_argument);

    EXPECT_THROW({ nn::Conv2d conv(1, 64, {0, 3}, {1, 1}, {1, 1}, true); }, std::invalid_argument);

    EXPECT_THROW({ nn::Conv2d conv(1, 64, {3, 3}, {0, 1}, {1, 1}, true); }, std::invalid_argument);

    EXPECT_THROW({ nn::Conv2d conv(1, 64, {3, 3}, {1, 1}, {-1, 1}, true); }, std::invalid_argument);
}
