...
INSTANTIATE_TEST_SUITE_P(BatchNorm1dTests, BatchNorm1dTest, ::testing::Values(DeviceType::kCPU));

INSTANTIATE_TEST_SUITE_P(BatchNorm2dTests, BatchNorm2dTest, ::testing::Values(DeviceType::kCPU));
