...
TEST_P(AvgPool2dOperatorTest, ForwardBasic)
{
    ...
    auto result = F::avg_pool2d(x, 2, 2, 0);
...
TEST_P(AvgPool2dOperatorTest, ForwardStride)
{
    ...
    auto result = F::avg_pool2d(x, std::make_pair(2, 2), std::make_pair(1, 1), std::make_pair(0, 0));
...
TEST_P(AvgPool2dOperatorTest, ForwardPad)
{
    ...
    auto result = F::avg_pool2d(x, 2, 1, 1);
...
TEST_P(AvgPool2dOperatorTest, ForwardSingleElement)
{
    ...
    auto result = F::avg_pool2d(x, 1, 1, 0);
