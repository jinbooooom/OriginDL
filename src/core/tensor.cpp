...
template void Tensor::create_tensor_from_data<unsigned long>(const unsigned long* data, size_t count, const Shape &shape);

template void Tensor::create_tensor_from_data_with_dtype<float>(const float* data, size_t count, const Shape &shape, DataType dtype);
template void Tensor::create_tensor_from_data_with_dtype<double>(const double* data, size_t count, const Shape &shape, DataType dtype);
template void Tensor::create_tensor_from_data_with_dtype<int32_t>(const int32_t* data, size_t count, const Shape &shape, DataType dtype);
template void Tensor::create_tensor_from_data_with_dtype<int8_t>(const int8_t* data, size_t count, const Shape &shape, DataType dtype);
