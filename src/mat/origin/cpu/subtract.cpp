...
std::unique_ptr<OriginMat> subtract(const OriginMat &a, const OriginMat &b)
{
    ...
    else
    {
        ...
        {
            THROW_INVALID_ARG(
                "Shape mismatch for subtraction - only scalar broadcasting supported. Shape A: {}, Shape B: {}",
    ...
    switch (a.dtype())
    {
        ...
        default:
            THROW_INVALID_ARG("Unsupported data type {} for subtraction operation", dtype_to_string(a.dtype()));
    }
