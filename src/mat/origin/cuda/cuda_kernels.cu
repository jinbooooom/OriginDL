...
template __global__ void vectorized_unary_kernel<float, ReLUOp>(const float *, float *, size_t, ReLUOp);
template __global__ void vectorized_unary_kernel<double, ReLUOp>(const double *, double *, size_t, ReLUOp);
template __global__ void vectorized_unary_kernel<int32_t, ReLUOp>(const int32_t *, int32_t *, size_t, ReLUOp);
template __global__ void vectorized_unary_kernel<int8_t, ReLUOp>(const int8_t *, int8_t *, size_t, ReLUOp);
