...
public:
    ...
    Conv2d(std::pair<int, int> stride, std::pair<int, int> pad) : stride_(stride), pad_(pad) {}
 ...
 */
Tensor conv2d(const Tensor &x, const Tensor &W, const Tensor *b = nullptr, std::pair<int, int> stride = {1, 1},
