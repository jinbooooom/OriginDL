...
public:
    ...
    AvgPool2d(std::pair<int, int> kernel_size, std::pair<int, int> stride = {0, 0},
 ...
 */
Tensor avg_pool2d(const Tensor &x, std::pair<int, int> kernel_size, std::pair<int, int> stride = {0, 0},
                  std::pair<int, int> pad = {0, 0});
